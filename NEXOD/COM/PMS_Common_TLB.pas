...
// $Rev: 98336 $
// File generated on 12/07/2023 07:56:19 from Type Library described below.

// ************************************************************************  //
// Type Lib: C:\Users\philippe\Documents\Dev\NEXOSale\bin\PMS.COMMON.tlb (1)
// LIBID: {55473A88-8D3C-3190-9A22-988C24B66EE3}
// LCID: 0
// Helpfile: 
// HelpString: 
// DepndLst: 
...
const
  ...
  PMS_COMMONMinorVersion = 6;

  LIBID_PMS_COMMON: TGUID = '{55473A88-8D3C-3190-9A22-988C24B66EE3}';
  ...
  CLASS_CLogMsgs: TGUID = '{DC6AE839-1D09-301B-A5A9-8E0A18238BF7}';
  ...
  CLASS_EDisconnected: TGUID = '{FC098C85-6D59-3B4D-B4BE-C8B883264BB8}';
  CLASS_EInvalidFormat: TGUID = '{AF61547E-4DFF-3CE7-BF0B-52EAC358B2CA}';
  CLASS_EOutOfRange: TGUID = '{AC50EDD3-FA85-3F42-B529-097F1B1E9CFA}';
  CLASS_CLogMsg: TGUID = '{3BE27E06-5C07-3EEA-B0F0-7E774EEBD9C8}';
  CLASS_CMiscExtensions: TGUID = '{D0471DEF-9904-3B78-9702-AA61BE85C221}';
  CLASS_ENotImplemented: TGUID = '{1FEE2250-3E07-35A0-B11C-A18E725BC931}';
  CLASS_CSafeBase: TGUID = '{97F0E951-1322-3ABA-B0D5-D4A1002EBED2}';
  CLASS_CStreamParameters: TGUID = '{AC0A9AC7-3256-3506-BD1D-BF857B4EB906}';
  CLASS_SendAsyncType: TGUID = '{B2C8C9AD-2CA4-3D75-A66E-24BA524F16C7}';
  CLASS_ServerOnStartDelegate: TGUID = '{47FCB518-FD47-3EAC-AF73-5E729E7D9EAF}';
  CLASS_ServerOnConnectDelegate: TGUID = '{268AD0D1-F07A-3800-8B4B-2769768D106C}';
  CLASS_ServerOnMessageDelegate: TGUID = '{38820122-C3BA-36AD-9DBB-009344172A8D}';
  CLASS_ServerOnDisconnectDelegate: TGUID = '{3989E1ED-5DF9-3FE6-BB87-37D107D77B0F}';
  CLASS_ServerOnStopDelegate: TGUID = '{9CA33867-6C4C-3E0F-AA13-92347063A922}';
  CLASS_ClientOnReceivedMessageDelegate: TGUID = '{8B5687E2-BA68-3253-B19D-17E91FB7BD1E}';
  CLASS_ClientOnSendMessageDelegate: TGUID = '{D12932A6-A2A1-3930-B900-4E8F5ACED4BC}';
  CLASS_ClientOnReplyDelegate: TGUID = '{7963883F-DF5B-3306-B203-C4C07F36F454}';
  CLASS_ClientServerOnMessageToLog: TGUID = '{DB36908C-DC3F-37C1-8C17-7D09327A8D14}';
  CLASS_ThreadFunction: TGUID = '{6E8EDE56-9727-3C81-BC55-F700EB5A196E}';
  CLASS_ThreadTerminates: TGUID = '{594F6327-019C-3FA2-A9FD-7F6677B7C67E}';
  CLASS_TimerCompleteDelegate: TGUID = '{3C00F96E-F120-3E28-B6B7-4F2C444ED216}';
  CLASS_Win32UIActivityDelegate: TGUID = '{21E7B358-63EF-35A5-BAC0-92CCCFA32585}';
  CLASS_FeedRecordDelegate: TGUID = '{B67512EE-AB3E-3B0D-984B-63FEC5208FFA}';
