...
const
	...
	CLASS_FConfirm: TGUID = '{5D076CDE-687E-349F-816E-CBF05EA660E4}';
	CLASS_FConfirmResult: TGUID = '{15122518-8E13-332D-8E4E-831CD35303EA}';
	CLASS_FProcessing: TGUID = '{C34D826F-DB43-31AD-993B-66D5A44275B3}';
	CLASS_FSelectPrinter: TGUID = '{DDCF0068-71D0-36B2-B155-31EBE30D1514}';
	CLASS_FSettings: TGUID = '{84E5D73D-C0FC-344E-8FE6-B1B557961EAF}';
	CLASS_FWait: TGUID = '{9FC29692-8BF8-372E-8F06-F0CBEA39C0D6}';
	CLASS_CheckToPrint: TGUID = '{60223B1F-298E-310C-9C32-CDD251E63A58}';
	CLASS_NexoOperation: TGUID = '{157BCD3B-1EEF-366E-AD75-94B2AB107C98}';
	CLASS_Receipts: TGUID = '{FB27B333-CBED-3EE8-A9FC-8A3B7298D640}';
	CLASS_ConnectRequestData: TGUID = '{8637A905-7519-3E70-A42E-2FFD3FC1B75A}';
	CLASS_ConnectRequest: TGUID = '{CC6AF090-4055-365E-B95F-7F4BF95FF2EC}';
	CLASS_ConnectReplyData: TGUID = '{D217CDDB-0AB1-36B2-B784-C8A46B72E288}';
	CLASS_ConnectReply: TGUID = '{CDF5F72B-118A-3B4E-BA05-22BB14F53E1C}';
	CLASS_ConnectRequestData_2: TGUID = '{BD8A8895-AD9D-357B-AE49-B859BEA47C38}';
	CLASS_ConnectRequest_2: TGUID = '{164234EC-365E-31C3-B6DD-49125FAE3733}';
	CLASS_ConnectReplyData_2: TGUID = '{7AAC4CF9-21EF-3A38-9094-E2D29B7C074C}';
	CLASS_ConnectReply_2: TGUID = '{E8FDD19B-B3DF-37CA-9296-D60990791210}';
...
type
	...
	_NEXOSALE = interface(IDispatch)
		...
		function Get_MainWindow: Int64; safecall;
		procedure Set_MainWindow(pRetVal: Int64); safecall;
