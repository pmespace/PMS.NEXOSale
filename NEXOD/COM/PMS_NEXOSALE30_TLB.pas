...
const
  ...
  CLASS_CardScheme: TGUID = '{26453A6E-C045-3D3D-9D82-F966EF45E477}';
  ...
  CLASS_FConfirm: TGUID = '{8A0AF322-8C0F-329E-8F66-15731CFEC25F}';
  CLASS_FConfirmResult: TGUID = '{83B74C76-5DEF-347D-B8D5-F2156425CDD5}';
  CLASS_FProcessing: TGUID = '{88AB5059-C39F-3C80-BE70-3AE4E4469EFB}';
  CLASS_FSelectPrinter: TGUID = '{C2EAF287-1757-3539-8958-3B8595AE614A}';
  CLASS_FSettings: TGUID = '{3F8D3F7D-E534-3E60-94C1-0B13F594BA76}';
  CLASS_FWait: TGUID = '{45177288-E5A1-3286-B1C2-108EA90649D1}';
  CLASS_CheckToPrint: TGUID = '{7F4C5F1A-568E-316E-B0EF-A8F7B19C8969}';
  CLASS_NexoOperation: TGUID = '{D3B42032-0230-3DF1-86DB-BC312C0AC55C}';
  CLASS_Receipts: TGUID = '{805758BE-E6E4-3409-981D-6FB4AFD9EE86}';
  CLASS_ConnectRequestData: TGUID = '{37F5A52C-39D2-329A-A4D1-8DBCA4AA4593}';
  CLASS_ConnectRequest: TGUID = '{32D49A70-79EA-3FF8-9E41-4027E6553D2C}';
  CLASS_ConnectReplyData: TGUID = '{42D28107-7B2E-3001-A5C2-2FC00D79A6EF}';
  CLASS_ConnectReply: TGUID = '{579416CB-2A41-377E-B64B-04D525BE9116}';
  CLASS_ConnectRequestData_2: TGUID = '{8C10FBEB-5EE3-3BD2-9367-00A980766D1F}';
  CLASS_ConnectRequest_2: TGUID = '{393F908B-667B-3A84-A4D3-24BB3EA35C4A}';
  CLASS_ConnectReplyData_2: TGUID = '{28F6FEFA-B7C6-3246-9BB3-A613B5FF406C}';
  CLASS_ConnectReply_2: TGUID = '{2FC803A2-7CBF-354E-A6CB-64C852DE7D5C}';
...
// *********************************************************************//
  _SettingsDisp = dispinterface
    ...
    property CardSchemes: IEnumerable dispid 300;
