...
type
	...
	IMC_PluginCallback = interface
		...
		/// <seealso cref="IMC_UICallbackResult" User interface callback result/>
		function onMC_UICallback(sender: IMC_PluginBase; aeType: TMC_UICallbackType; acParamsIn: IMC_UICallbackParamsIn;
			out zcParamOut: IMC_UICallbackResult): TMC_CallbackResult; stdcall;
		/// <summary>
