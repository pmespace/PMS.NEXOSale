...
type
	...
	public
		constructor create(aiTimeOut: integer; aeSecurityRequestLevel: TMC_UICBSecurityRequestLevel; aeCarAllowed: TMC_UICallbackCarAllowedSet);
			reintroduce;
		property timeout: integer read get_TimeOut;
	...
	public
		constructor create(const aeCommandId: TMC_CPOSCommandId; const aeDeviceType: TMC_DeviceType; const aeDeviceNum: integer;
			const asOriginalCommand: wideString; const aeReportType: TMC_ReportType; const asPrintingLayout: wideString; const asXML: wideString);
			reintroduce;
...
constructor TMC_UICallbackPISecurity.create(aeSecurityID: TMC_UICBPISecurity; aiTimeOut: integer;
	aeSecurityRequestLevel: TMC_UICBSecurityRequestLevel);
begin
	inherited create('');
...
constructor TMC_UICallbackPIGetKey.create(aiTimeOut: integer; aeSecurityRequestLevel: TMC_UICBSecurityRequestLevel;
	aeCarAllowed: TMC_UICallbackCarAllowedSet);
begin
	inherited create('');
...
constructor TMC_CPOSCommandPrintXMLStreamContext.create(const aeCommandId: TMC_CPOSCommandId; const aeDeviceType: TMC_DeviceType;
	const aeDeviceNum: integer; const asOriginalCommand: wideString; const aeReportType: TMC_ReportType; const asPrintingLayout, asXML: wideString);
begin
	inherited create('');
