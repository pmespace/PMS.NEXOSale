...
uses
  ...
  PMS_NEXO_TLB in 'COM\PMS_NEXO_TLB.pas',
  PMS_NEXOSale_TLB in 'COM\PMS_NEXOSale_TLB.pas',
...
begin
	...
	try
		...
		on e: Exception do zcErr := TMC_Error.create(-1, e.message, 0);
	end;
end;
